...
class DungeonMap:
    def __init__(self, chameleon:Chameleon):
        self.rooms = {}
    ...
    def set_player_location(self, room:Room):
        ...
        self.chameleon.set_random_starting_room(self)


    def move_player(self, direction:Direction.value, noise_scale:int):
        if direction not in self.rooms[self.player_location]:
            click.echo("You can't go that way!")
            return False
        self.set_noise_scale(1)
        self.chameleon.move_towards_player(self, noise_scale)
        self.player_location = self.rooms[self.player_location][direction]
        return True
    

    def set_noise_scale(self, noise_scale: int):
        self.chameleon.move_towards_player(noise_scale)
...
chameleon = Chameleon()
chameleon.set_random_starting_room(DungeonMap)
# class DungeonMap:
#     def __init__(self):
#         self.rooms = {}
#         self.player_location = None
